...
class BannerRepositoryTest {
    ...
    void HomeBannerDto_프로젝션_조회_테스트() {
        ...
        em.persist(new Banner("title1", "banner1", "content1", "additional1"));
        em.persist(new Banner("title2", "banner2", "content2", "additional2"));
        em.persist(new Banner("title3", "banner3", "content3", "additional3"));
        ...
        assertThat(result)
                .anyMatch(dto -> dto.getBannerUrl().equals("banner1"))
                .anyMatch(dto -> dto.getBannerUrl().equals("banner2"))
                .anyMatch(dto -> dto.getBannerUrl().equals("banner3"));
    }
