...
public class HomeDto extends RepresentationModel<HomeDto> {
    ...
    @Builder
    protected HomeDto(User user, Long totalContainer, String phrase, StatisticsInfoDto latestWriters, List<HomeBannerDto> banners) {
        this(
        ...
        latestWriters.getStatisticsUserDto().stream().limit(3).forEach(u ->
